  ...
  if (compact) {
    return (
      <div className={`${baseClasses} ${className} flex items-center gap-3 px-3 py-2`}>
        <img src="/itsmyapp_logo.png" alt="itsmyapp.co.uk logo" className="h-8 w-8 rounded-md object-cover" loading="lazy" />
  ...
  return (
    <div className={`${baseClasses} ${className} flex flex-col gap-2 p-3 sm:flex-row sm:items-center sm:justify-between`}>
      <div className="flex items-center gap-3">
        <img src="/itsmyapp_logo.png" alt="itsmyapp.co.uk logo" className="h-10 w-10 rounded-lg object-cover" loading="lazy" />
